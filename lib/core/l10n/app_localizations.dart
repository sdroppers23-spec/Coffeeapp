...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'ek43_division': 'EK43 Division',
      'comandante_clicks': 'Comandante Clicks',
      'brew_temp': 'Brew Temp (°C)',
      'grind_settings_label': 'Grind Settings',
      'microns': 'Microns (μm)',
    ...
    'uk': {
      ...
      'min': 'ХВ',
      'sec': 'СЕК',
      'grinder_settings': 'Налаштування млинка',
      'ek43_division': 'Поділка EK43',
      'comandante_clicks': 'Кліки Comandante',
      'brew_temp': 'Темп. заварювання (°C)',
      'grind_settings_label': 'Налаштування помолу',
      'microns': 'Мікрони (μm)',
      'brew_ratio': 'Brew Ratio',
