...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'process_asc': 'Process (A-Z)',
      'process_desc': 'Process (Z-A)',
      'country_region_asc': 'Country & Region (A-Z)',
      'country_region_desc': 'Country & Region (Z-A)',
    ...
    'uk': {
      ...
      'name_asc': 'Назва (А-Я)',
      'name_desc': 'Назва (Я-А)',
      'price_asc': 'Ціна (Спочатку дешева)',
      'price_desc': 'Ціна (Спочатку дорога)',
      'country_asc': 'Країна (А-Я)',
      'country_desc': 'Країна (Я-А)',
      'region_asc': 'Регіон (А-Я)',
      'region_desc': 'Регіон (Я-А)',
      'process_asc': 'Обробка (А-Я)',
      'process_desc': 'Обробка (Я-А)',
      'country_region_asc': 'Країна та Регіон (А-Я)',
      'country_region_desc': 'Країна та Регіон (Я-А)',
