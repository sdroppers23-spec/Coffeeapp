...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'add_new_roaster': 'Add Roaster',
      'search_roaster': 'Search Roaster',
      ...
      'discard': 'Discard',
      'save_lot_confirmation_title': 'Save Lot?',
      'save_lot_confirmation_desc': 'Are you sure you want to save this coffee lot?',
    ...
    'uk': {
      ...
      'add_new_roaster': 'Додати обсмажчика',
      'search_roaster': 'Пошук обсмажчика',
      'roaster_name_field': 'Назва обсмажчика',
      'coffee_name_field': 'Назва кави',
      'discard_changes_title': 'Скасувати зміни?',
      'discard_changes_msg': 'У вас є незбережені зміни. Ви впевнені, що хочете їх скасувати?',
      'discard': 'Скасувати',
      'save_lot_confirmation_title': 'Зберегти лот?',
      'save_lot_confirmation_desc': 'Ви впевнені, що хочете зберегти цей лот кави?',
      'keep_editing': 'Продовжити редагування',
      'roaster_city': 'Місто обсмажчика',
