...
class LotDesignConfig {
  ...
  const LotDesignConfig({
    ...
    this.navBarOpacity = 0.05,
    this.navBarBlur = 25.8,
    this.navBarBaseOpacity = 0.51,
    this.flavorCardOpacity = 0.05,
    this.flavorCardBlur = 25.8,
    this.flavorCardBaseOpacity = 0.51,
    this.profileOpacity = 0.05,
    this.profileBlur = 25.8,
    this.profileBaseOpacity = 0.51,
  });
