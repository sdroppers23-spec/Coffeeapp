...
class ProcessingMethodInfo {
  ...
  final List<String> traits; // Key characteristics (e.g., "Funky", "Clean")
...
class ProcessingMethodsRepository {
  static const List<ProcessingMethodInfo> methods = [
    ...
    ProcessingMethodInfo(
      ...
      traits: ['Controlled', 'Floral', 'Smooth'],
    ),
    ProcessingMethodInfo(
      id: 'koji',
  ...
  static ProcessingMethodInfo? getByMatchingName(String name) {
    ...
    for (final method in methods) {
      ...
      // Also match by localized common parts if needed
    }
    ...
    if (lower.contains('thermal') || lower.contains('термал')) return getById('thermal_shock');
