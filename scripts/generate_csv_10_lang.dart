...
void main() {
  ...
  addBean(
      ...
      '31',
      '88');
  addBean(2, '🇰🇪', 'Kenya', 'Kenya 20 (SL28)', 'SL28', 'Washed',
      'Berry coffee with cashew.', 'Ягідна кава з кеш’ю.', '20', '85.5');
  addBean(
      2,
      '🇷🇼',
      'Rwanda',
  ...
  addBean(
      ...
      '4',
      '86');
  addBean(2, '🇨🇴', 'Colombia', 'Colombia 9 (Gesha)', 'Gesha', 'Natural',
      'Tropics and blackberry.', 'Тропіки та ожина.', '9', '87.5');
  addBean(2, '🇨🇷', 'Costa Rica', 'Costa Rica 12 (Caturra)', 'Caturra',
      'Natural', 'Cinnamon and apple.', 'Кориця та яблуко.', '12', '86.5');
  addBean(
      2,
      '🇮🇩',
      'Indonesia',
      ...
      '5',
      '85.75');
  addBean(2, '🇪🇹', 'Ethiopia', 'Ethiopia 8 (Heirloom)', 'Heirloom', 'Washed',
      'Jasmine and apricot.', 'Жасмин та абрикос.', '8', '85');
  addBean(2, '🇨🇴', 'Colombia', 'Colombia 2 (Decaf)', 'Caturra',
      'Thermal Shock', 'Mandarin decaf.', 'Мандарин без кофеїну.', '2', '86.5');
  addBean(2, '🇪🇹', 'Ethiopia', 'Ethiopia 37 (Heirloom)', 'Heirloom',
      'Anaerobic Natural', 'Peach acidity.', 'Персик та яблуко.', '37', '86.5');
  addBean(2, '🇰🇪', 'Kenya', 'Kenya 10 (SL28)', 'SL28', 'Washed',
      'Dogwood and apple.', 'Кизил та яблуко.', '10', '85.25');
  addBean(2, '🌍', 'Colombia', 'BB2 Blend', 'Mixed', 'Mixed',
      'Currant and tropics.', 'Смородина та тропіки.', '2', '85');
